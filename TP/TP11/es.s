...
@ Ajout Dec 2020 : LireChaine : Denis B.
...
@ EcrCar :
@    ecriture d'un caract�re dont la valeur est dans r1
EcrCar:
   mov ip, sp
   stmfd sp!, {r0, r1, r2, r3, fp, ip, lr, pc}
   sub     fp, ip, #4
...
@ EcrChn :
@    ecriture de la chaine sans retour � la ligne dont l'adresse est dans r1
EcrChn:
   mov ip, sp
   stmfd sp!, {r0, r1, r2, r3, fp, ip, lr, pc}
   sub     fp, ip, #4
...
@ EcrHexa32 :
@    ecriture d'un mot de 32 bits en hexad�cimal
...
EcrHexa32:
   ...
   @ EcrHexa16 :
@    ecriture d'un demi mot de 16 bits en hexad�cimal
...
@ EcrHexa8 :
@    ecriture d'un octet en hexad�cimal
...
@ LireChaine :
@    lecture d'une chaine de caracteres tapee au clavier 
@    (1 ligne de 80 caracteres maximum)
@    l'adresse de la chaine doit etre donnee dans r1
LireChaine:
   mov ip, sp
   stmfd sp!, {r0, r1, r2, r3, fp, ip, lr, pc}
   sub     fp, ip, #4
